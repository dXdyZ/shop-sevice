...
public class FeedbackService {
    ...
    public Feedback createFeedback(UUID productPublicId, UUID userPublicId, CreateFeedback createFeedback) throws ProductNotFoundException {
        ...
        Feedback feedback = FeedbackMapper.createFromDto(createFeedback);
